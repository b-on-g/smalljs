...
;
	($.$bog_smalljs_top) = class $bog_smalljs_top extends ($.$mol_view) {
		...
		Search(){
			const obj = new this.$.$mol_button_minor();
			(obj.click) = (next) => ((this.search_open(next)));
			(obj.sub) = () => ([
				(this.Search_icon()), 
				(this.Search_label()), 
				(this.Search_hint())
		...
		Nav_docs_label(){
			return (this.$.$mol_locale.text("$bog_smalljs_top_Nav_docs_label"));
		}
		Nav_docs_chevron(){
		...
		Nav_docs(){
			const obj = new this.$.$mol_button_minor();
			(obj.click) = (next) => ((this.nav_docs_open(next)));
			(obj.sub) = () => ([(this.Nav_docs_label()), (this.Nav_docs_chevron())]);
			return obj;
		}
		Nav_playground(){
			const obj = new this.$.$mol_link();
		...
		Nav_ecosystem_label(){
			return (this.$.$mol_locale.text("$bog_smalljs_top_Nav_ecosystem_label"));
		}
		Nav_ecosystem_chevron(){
			const obj = new this.$.$mol_icon_chevron_down();
			return obj;
		}
		Nav_ecosystem(){
			const obj = new this.$.$mol_button_minor();
			(obj.click) = (next) => ((this.nav_ecosystem_open(next)));
			(obj.sub) = () => ([(this.Nav_ecosystem_label()), (this.Nav_ecosystem_chevron())]);
			return obj;
		}
		Nav_about_label(){
			return (this.$.$mol_locale.text("$bog_smalljs_top_Nav_about_label"));
		}
		Nav_about_chevron(){
			const obj = new this.$.$mol_icon_chevron_down();
			return obj;
		...
		Nav_about(){
			const obj = new this.$.$mol_button_minor();
			(obj.click) = (next) => ((this.nav_about_open(next)));
			(obj.sub) = () => ([(this.Nav_about_label()), (this.Nav_about_chevron())]);
			return obj;
		}
		Nav_support_label(){
			return (this.$.$mol_locale.text("$bog_smalljs_top_Nav_support_label"));
		}
		Nav_support_chevron(){
			const obj = new this.$.$mol_icon_chevron_down();
			return obj;
		...
		Nav_support(){
			const obj = new this.$.$mol_button_minor();
			(obj.click) = (next) => ((this.nav_support_open(next)));
			(obj.sub) = () => ([(this.Nav_support_label()), (this.Nav_support_chevron())]);
			return obj;
		}
		Nav(){
			const obj = new this.$.$mol_view();
	...
	($mol_mem(($.$bog_smalljs_top.prototype), "Nav_docs_chevron"));
	($mol_mem(($.$bog_smalljs_top.prototype), "Nav_docs"));
	($mol_mem(($.$bog_smalljs_top.prototype), "Nav_playground"));
	($mol_mem(($.$bog_smalljs_top.prototype), "Nav_ecosystem_chevron"));
	($mol_mem(($.$bog_smalljs_top.prototype), "Nav_ecosystem"));
	($mol_mem(($.$bog_smalljs_top.prototype), "Nav_about_chevron"));
	($mol_mem(($.$bog_smalljs_top.prototype), "Nav_about"));
	($mol_mem(($.$bog_smalljs_top.prototype), "Nav_support_chevron"));
	($mol_mem(($.$bog_smalljs_top.prototype), "Nav_support"));
	...
	($mol_mem(($.$bog_smalljs_top.prototype), "search_open"));
	($mol_mem(($.$bog_smalljs_top.prototype), "nav_docs_open"));
	($mol_mem(($.$bog_smalljs_top.prototype), "nav_ecosystem_open"));
	($mol_mem(($.$bog_smalljs_top.prototype), "nav_about_open"));
	($mol_mem(($.$bog_smalljs_top.prototype), "nav_support_open"));
...
;
	($.$bog_smalljs_landing) = class $bog_smalljs_landing extends ($.$mol_view) {
		...
		Hero_cta_install(){
			...
			(obj.arg) = () => ({"section": "docs", "page": "install"});
			return obj;
		}
		Hero_cta_play_label(){
...
;
	($.$bog_smalljs_docs) = class $bog_smalljs_docs extends ($.$mol_view) {
		Group1_title(){
			return (this.$.$mol_locale.text("$bog_smalljs_docs_Group1_title"));
		}
		Group1(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Group1_title())]);
			return obj;
		}
		Group2_title(){
			return (this.$.$mol_locale.text("$bog_smalljs_docs_Group2_title"));
		}
		Group2(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Group2_title())]);
			return obj;
		}
		Sidebar(){
			const obj = new this.$.$mol_scroll();
			(obj.sub) = () => ([(this.Group1()), (this.Group2())]);
			return obj;
		}
		Title_text(){
			return (this.$.$mol_locale.text("$bog_smalljs_docs_Title_text"));
		}
		Title(){
			const obj = new this.$.$mol_view();
		...
		Body(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ((this.$.$mol_locale.text("$bog_smalljs_docs_Body_text")));
			return obj;
		}
		Content(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Title()), (this.Body())]);
			return obj;
		}
		Edit(){
			const obj = new this.$.$mol_link();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_smalljs_docs_Edit_title")));
			(obj.uri) = () => ((this.edit_uri()));
			return obj;
		}
		Prev(){
			const obj = new this.$.$mol_link();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_smalljs_docs_Prev_title")));
			(obj.arg) = () => ({"section": "docs", "page": ""});
			return obj;
		}
		Next(){
			const obj = new this.$.$mol_link();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_smalljs_docs_Next_title")));
			(obj.arg) = () => ({"section": "docs", "page": ""});
			return obj;
		}
		Nav(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Prev()), (this.Next())]);
			return obj;
		}
		Main(){
			const obj = new this.$.$mol_scroll();
		...
		Toc_title(){
			return (this.$.$mol_locale.text("$bog_smalljs_docs_Toc_title"));
		}
		Toc(){
			const obj = new this.$.$mol_scroll();
			(obj.sub) = () => ([(this.Toc_title())]);
			return obj;
		}
		edit_uri(){
			return "https://github.com/b-on-g/smalljs/edit/master/docs/page.view.tree";
		}
		sub(){
			return [
				(this.Sidebar()), 
	...
	($mol_mem(($.$bog_smalljs_docs.prototype), "Group1"));
	($mol_mem(($.$bog_smalljs_docs.prototype), "Group2"));
	($mol_mem(($.$bog_smalljs_docs.prototype), "Sidebar"));
	($mol_mem(($.$bog_smalljs_docs.prototype), "Title"));
	($mol_mem(($.$bog_smalljs_docs.prototype), "Body"));
	($mol_mem(($.$bog_smalljs_docs.prototype), "Content"));
...
;
	($.$bog_smalljs_playground) = class $bog_smalljs_playground extends ($.$mol_view) {
		Title(){
			return (this.$.$mol_locale.text("$bog_smalljs_playground_Title"));
		}
		Body(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ((this.$.$mol_locale.text("$bog_smalljs_playground_Body_text")));
			return obj;
		}
		sub(){
	...
	($mol_mem(($.$bog_smalljs_playground.prototype), "Body"));
...
;
	($.$bog_smalljs_app) = class $bog_smalljs_app extends ($.$mol_view) {
		Theme(){
			const obj = new this.$.$bog_theme_auto();
