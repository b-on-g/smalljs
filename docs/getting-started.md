...
> Coming from React or Vue and nothing makes sense? Read [Mental model](#!section=docs/page=mental-model) first: five minutes on where `computed`, `watch`, lifecycle hooks and data loading went.
