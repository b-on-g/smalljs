...
$mol работает в любом редакторе, но небольшой набор инструментов делает `.view.tree` и типизированные стили гораздо удобнее: генератор проектов, языковой сервер и интеграции с редакторами Zed и VS Code.
