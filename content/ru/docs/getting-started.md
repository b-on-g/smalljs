...
> Пришли из React или Vue и ничего не складывается? Прочтите сначала [Ментальную модель](#!section=docs/page=mental-model): пять минут о том, куда делись `computed`, `watch`, хуки жизненного цикла и загрузка данных.
