...
অ্যাসিঙ্ক ভ্যালু কেবল একটি রিয়্যাক্টিভ প্রপার্টি, যা এমনভাবে লেখা যেন রেসপন্স আগে থেকেই হাজির। রিকোয়েস্ট চলাকালীন `$mol_fetch` ফাইবারকে স্থগিত রাখে আর ডেটা এসে পৌঁছালে প্রপার্টিটি পার্স করা মানটি ফেরত দেয়, তাই যে ভিউ এটি পড়ে সেটি বিল্ট-ইন লোডিং স্টেট দেখায়——আর ব্যর্থ রিকোয়েস্ট এরর স্টেট হিসেবে ভেসে ওঠে। আপনি কোনো `isLoading` ফ্ল্যাগ বা `try`/`catch` লেখেন না। কলটি যায় `this.$`, অর্থাৎ কম্পোনেন্টের কনটেক্সটের মধ্য দিয়ে, তাই একটি [টেস্ট](#!section=docs/page=testing) নেটওয়ার্কটিকে একটি মক দিয়ে বদলে দিতে পারে।
