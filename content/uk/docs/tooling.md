...
$mol працює в будь-якому редакторі, але невеликий набір інструментів робить `.view.tree` і типізовані стилі значно зручнішими: генератор проєктів, мовний сервер та інтеграції з редакторами Zed і VS Code.
