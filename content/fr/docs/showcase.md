...
## Hackathons et usage commercial

$mol a gagné à plusieurs reprises lors de hackathons : première place à Beautiful Code ([$hyoo_budget](https://budget.hyoo.ru)), première place à l'AC-VO-PPR-Hackathon (contrôle par gestes et voix d'un affichage urbain), et des prototypes primés à More Tech, Moscow City Hack et Dev Hack. Il est aussi présent dans des systèmes commerciaux et industriels — d'un back-office de boutique en ligne à des panneaux de contrôle de défense anti-drones. La [page des histoires de réussite](https://mol.hyoo.ru/#!section=docs/=xanlom_yimh6x) de $mol en donne les détails.
